...
[English](https://github.com/Deo-EM/vr-player/blob/main/README.md) · **简体中文**
...
一个轻量级的 **360° 全景视频 VR 播放器**，基于纯 WebGL 实现，零运行时依赖，**gzip 后约 6 KB**。

![VR Player —— 拖动查看 360° 全景视频](https://raw.githubusercontent.com/Deo-EM/vr-player/main/docs/demo.gif)

> **[▶ 在线体验](https://deo-em.github.io/vr-player/)** —— 用手机打开并点击 **Gyro: off**，转动设备即可环视。
...
| Pannellum | ~100 KB | ~35 KB | 轻量全景查看器 |
...
如果你只需要播放**等距柱状投影的 360° 视频**——不需要 3D 模型、场景图和插件生态——vr-player 能用几分之一的体积做到。
...
仓库内置一个功能完整的调试页，包含视频源输入、进度条、FOV / WebGL 版本 / 超采样控制与陀螺仪开关。

**[▶ https://deo-em.github.io/vr-player/](https://deo-em.github.io/vr-player/)**

![VR Player Demo 页面与控制条](https://raw.githubusercontent.com/Deo-EM/vr-player/main/docs/preview.png)
...
pnpm demo:https    # HTTPS —— 真机陀螺仪必须
```

在 URL 后追加 `?debug` 可加载页内 vConsole，方便手机端调试。
...
见 [CONTRIBUTING.md](https://github.com/Deo-EM/vr-player/blob/main/CONTRIBUTING.md)。
